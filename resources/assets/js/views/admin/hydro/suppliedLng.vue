              		...
              		<div data-v-744e717e="" class="table-responsive">
              			<table data-v-744e717e="" class="table">
                            ...
                            <td class="" v-if="today_date>=setLngDate(nominationLngData.lngDate)" >
                                ...
                                <a  href="javascript:void(0)"v-if="nominationLngData.tare_weight == '0.00'"  @click="setNominationId(nominationLngData.id,'tare_weight')" title="Add tare weight"> <i class="fa fa-pencil text-blue mr-3" ></i></a> 
                                <a v-else>{{nominationLngData.tare_weight}} </a>
                            </td>
                            <td v-if="today_date>=setLngDate(nominationLngData.lngDate)" >
                                <a  href="javascript:void(0)" v-if="nominationLngData.tare_weight != '0.00' && nominationLngData.gross_weight == '0.00'" @click="setNominationId(nominationLngData.id,'gross_weight')" title="Add gross weight"> <i class="fa fa-pencil text-blue mr-3" ></i></a>
